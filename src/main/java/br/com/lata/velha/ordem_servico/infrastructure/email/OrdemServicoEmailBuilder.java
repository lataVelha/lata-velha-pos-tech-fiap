...
@Component
public class OrdemServicoEmailBuilder implements OrdemServicoEmailBuilderPort {

    public Map<String, Object> buildVariables(OrdemServico os, Proprietario proprietario, Veiculo veiculo) {
    ...
    public String getAssunto(StatusOrdemServico status) {
    ...
    private void addAprovadosRecusados(Map<String, Object> variables, OrdemServico os) {
        ...
        BigDecimal valorAprovado = calcularTotal(os, StatusExecucaoServico.APROVADO);
        BigDecimal valorRecusado = calcularTotal(os, StatusExecucaoServico.RECUSADO);
