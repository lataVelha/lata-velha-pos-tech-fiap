...
-- VEÍCULOS
-- Carlos (id=1)
INSERT INTO VEICULO (PROPRIETARIO_ID, PLACA, MARCA, MODELO, ANO, COR)
VALUES (1, 'ABC1D23', 'Fiat', 'Uno', 2020, 'Prata');

INSERT INTO VEICULO (PROPRIETARIO_ID, PLACA, MARCA, MODELO, ANO, COR)
VALUES (1, 'XYZ4E56', 'Volkswagen', 'Gol', 2019, 'Branco');

-- Ana (id=2)
INSERT INTO VEICULO (PROPRIETARIO_ID, PLACA, MARCA, MODELO, ANO, COR)
VALUES (2, 'DEF7G89', 'Toyota', 'Corolla', 2023, 'Preto');

-- Auto Center (id=3)
INSERT INTO VEICULO (PROPRIETARIO_ID, PLACA, MARCA, MODELO, ANO, COR)
VALUES (3, 'GHI1J23', 'Chevrolet', 'Onix', 2022, 'Vermelho');

INSERT INTO VEICULO (PROPRIETARIO_ID, PLACA, MARCA, MODELO, ANO, COR)
VALUES (3, 'JKL4M56', 'Hyundai', 'HB20', 2021, 'Azul');

INSERT INTO VEICULO (PROPRIETARIO_ID, PLACA, MARCA, MODELO, ANO, COR)
VALUES (3, 'MNO7P89', 'Honda', 'Civic', 2024, 'Cinza');